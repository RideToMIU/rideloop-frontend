import RideIcon from "../../assets/icons/ride.svg?react";
const RideComponent = () => {
  return (
    <li className="list-row">
      ...
      <div className="py-2">
        <div className="text-xs opacity-100 flex flex-row gap-2">
          <svg
        ...
        <div className="text-xs font-bold opacity-60 flex flex-row gap-2">
          <svg
            className="size-[1.2em]"
            viewBox="0 0 24 24"
            fill="none"
        ...
        <div className="text-xs font-bold flex flex-row gap-2">
          <svg
            fill="#000000"
            className="size-[1.2em]"
            viewBox="0 0 32 32"
          ...
          <span className="text-xs">06/23/2025@12:00hrs</span>
        </div>
      </div>
